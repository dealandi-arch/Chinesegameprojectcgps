  ...
  if (waitingRoom) {
    return (
      <div className="rounded-2xl border border-white/10 bg-white/5 p-6 text-center">
        <p className="text-sm text-stone-400">Share this code:</p>
        <p className="mt-2 text-4xl font-bold tracking-widest text-amber-300">
      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <div className="mt-4 flex gap-2">
          <input
            ...
            placeholder="ABC123"
            maxLength={6}
            className="flex-1 rounded-lg border border-white/10 bg-black/30 px-3 py-2 text-sm uppercase tracking-widest text-white outline-none focus:border-amber-400/60"
          />
          <button
            onClick={handleJoin}
            disabled={isPending}
            className="rounded-full border border-white/10 px-4 py-2 text-sm font-medium text-stone-300 transition-colors hover:border-amber-400/50 disabled:opacity-60"
          >
